...
//
//	mockgen -source=redis.go -destination=mock_redis.go -package=redisData
//

// Package redisData is a generated GoMock package.
package migration
...
// Mockcommands is a mock of Redis interface.
