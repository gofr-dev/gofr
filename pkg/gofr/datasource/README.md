...
- DEBUG: Logs the exact query being executed.

> Additional logs should be added to enhance debugging and improving user experience.
...
- Method Registration:
   ...
   Create a Method function in gofr.go (similar to the existing one) that accepts the newly defined interface.
