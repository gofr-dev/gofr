...
// Source: pkg/gofr/datasource/couchbase/logger.go
//
// Generated by this command:
//
//	mockgen -source=pkg/gofr/datasource/couchbase/logger.go -destination=pkg/gofr/datasource/couchbase/mock_logger.go -package=couchbase
//
