...
func TestConnect(t *testing.T) {
	...
	mockLogger.EXPECT().Info("azure eventhub producer client setup success")
	mockLogger.EXPECT().Info("azure eventhub container client setup success")
	mockLogger.EXPECT().Info("azure eventhub blobstore client setup success")
	mockLogger.EXPECT().Info("azure eventhub consumer client setup success")
	mockLogger.EXPECT().Info("azure eventhub processor setup success")
	mockLogger.EXPECT().Info("azure eventhub processor running successfully").AnyTimes()
