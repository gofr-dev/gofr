...
// Source: /Users/zopdev/go/pkg/mod/github.com/arangodb/go-driver/v2@v2.3.0/arangodb/client.go
//
// Generated by this command:
//
//	mockgen -source=/Users/zopdev/go/pkg/mod/github.com/arangodb/go-driver/v2@v2.3.0/arangodb/client.go -destination=mock_interfaces.go -package=arangodb
//
...
func (m *MockClient) GetDeploymentId(ctx context.Context) (arangodb.DeploymentIdResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeploymentId", ctx)
	ret0, _ := ret[0].(arangodb.DeploymentIdResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDeploymentId indicates an expected call of GetDeploymentId.
func (mr *MockClientMockRecorder) GetDeploymentId(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeploymentId", reflect.TypeOf((*MockClient)(nil).GetDeploymentId), ctx)
}
...
func (m *MockClient) Metrics(ctx context.Context, dbName string, serverId *string) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Metrics", ctx, dbName, serverId)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockClientMockRecorder) Metrics(ctx, dbName, serverId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Metrics", reflect.TypeOf((*MockClient)(nil).Metrics), ctx, dbName, serverId)
}
...
func (m *MockClient) Shutdown(ctx context.Context, dbName string, graceful *bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Shutdown", ctx, dbName, graceful)
	ret0, _ := ret[0].(error)
	return ret0
}

// Shutdown indicates an expected call of Shutdown.
func (mr *MockClientMockRecorder) Shutdown(ctx, dbName, graceful any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Shutdown", reflect.TypeOf((*MockClient)(nil).Shutdown), ctx, dbName, graceful)
}

// ShutdownInfo mocks base method.
func (m *MockClient) ShutdownInfo(ctx context.Context, dbName string) (arangodb.ShutdownInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ShutdownInfo", ctx, dbName)
	ret0, _ := ret[0].(arangodb.ShutdownInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ShutdownInfo indicates an expected call of ShutdownInfo.
func (mr *MockClientMockRecorder) ShutdownInfo(ctx, dbName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ShutdownInfo", reflect.TypeOf((*MockClient)(nil).ShutdownInfo), ctx, dbName)
}
