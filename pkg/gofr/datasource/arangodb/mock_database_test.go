...
// Source: $GOMODCACHE/github.com/arangodb/go-driver/v2@v2.1.6/arangodb/database.go
//
// Generated by this command:
//
//	mockgen -source=$GOMODCACHE/github.com/arangodb/go-driver/v2@v2.1.6/arangodb/database.go -destination=mock_database_test.go -package=arangodb
//
