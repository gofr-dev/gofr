...
// Source: $GOMODCACHE/github.com/arangodb/go-driver/v2@v2.3.1/arangodb/collection.go
//
// Generated by this command:
//
//	mockgen -source=$GOMODCACHE/github.com/arangodb/go-driver/v2@v2.3.1/arangodb/collection.go -destination=mock_collection_test.go -package=arangodb
//
