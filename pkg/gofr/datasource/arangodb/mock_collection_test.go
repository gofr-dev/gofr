...
// Source: $GOMODCACHE/github.com/arangodb/go-driver/v2@v2.4.1/arangodb/collection.go
//
// Generated by this command:
//
//	mockgen -source=$GOMODCACHE/github.com/arangodb/go-driver/v2@v2.4.1/arangodb/collection.go -destination=mock_collection_test.go -package=arangodb
//
...
// EnsureVectorIndex mocks base method.
func (m *MockCollection) EnsureVectorIndex(ctx context.Context, fields []string, params *arangodb.VectorParams, options *arangodb.CreateVectorIndexOptions) (arangodb.IndexResponse, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureVectorIndex", ctx, fields, params, options)
	ret0, _ := ret[0].(arangodb.IndexResponse)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
// EnsureVectorIndex indicates an expected call of EnsureVectorIndex.
func (mr *MockCollectionMockRecorder) EnsureVectorIndex(ctx, fields, params, options any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsureVectorIndex", reflect.TypeOf((*MockCollection)(nil).EnsureVectorIndex), ctx, fields, params, options)
}
...
// IndexesWithOptions mocks base method.
func (m *MockCollection) IndexesWithOptions(ctx context.Context, opts *arangodb.IndexListOptions) ([]arangodb.IndexResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IndexesWithOptions", ctx, opts)
	ret0, _ := ret[0].([]arangodb.IndexResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IndexesWithOptions indicates an expected call of IndexesWithOptions.
func (mr *MockCollectionMockRecorder) IndexesWithOptions(ctx, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IndexesWithOptions", reflect.TypeOf((*MockCollection)(nil).IndexesWithOptions), ctx, opts)
}
