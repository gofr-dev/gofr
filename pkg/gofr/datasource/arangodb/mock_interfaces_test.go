...
// Source: $GOMODCACHE/github.com/arangodb/go-driver/v2@v2.3.0/arangodb/client.go
//
// Generated by this command:
//
//	mockgen -source=$GOMODCACHE/github.com/arangodb/go-driver/v2@v2.3.0/arangodb/client.go -destination=mock_interfaces_test.go -package=arangodb
//
