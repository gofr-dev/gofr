...
func (m *MockStorageProvider) ListDir(ctx context.Context, prefix string) ([]file.ObjectInfo, []string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListDir", ctx, prefix)
	ret0, _ := ret[0].([]file.ObjectInfo)
	ret1, _ := ret[1].([]string)
	ret2, _ := ret[2].(error)
...
func (m *MockStorageProvider) StatObject(ctx context.Context, name string) (*file.ObjectInfo, error) {
	m.ctrl.T.Helper()
