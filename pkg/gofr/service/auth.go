...
func (a *authProvider) GetWithHeaders(ctx context.Context, path string, queryParams map[string]any,
	headers map[string]string) (*http.Response, error) {
	return a.doAuthWithHeaders(ctx, func(ctx context.Context, path string, queryParams map[string]any, _ []byte, headers map[string]string) (*http.Response, error) {
...
func (a *authProvider) DeleteWithHeaders(ctx context.Context, path string, body []byte, headers map[string]string) (*http.Response, error) {
	return a.doAuthWithHeaders(ctx, func(ctx context.Context, path string, _ map[string]any, body []byte, headers map[string]string) (*http.Response, error) {
