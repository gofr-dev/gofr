...
func Test_Run_SuccessCallRegisteredArgument(t *testing.T) {
	...
	logs := testutil.StdoutOutputForFunc(func() {
		c.Run(container.NewContainer(config.NewEnvFile(".env", mocklogger.NewMockLogger(mocklogger.DEBUGLOG))))
	})
...
func Test_Run_SuccessSkipEmptySpaceAndMatchCommandWithSpace(t *testing.T) {
	...
	logs := testutil.StdoutOutputForFunc(func() {
		c.Run(container.NewContainer(config.NewEnvFile("", mocklogger.NewMockLogger(mocklogger.DEBUGLOG))))
	})
