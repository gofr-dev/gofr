...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [CassandraWithContext] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [Clickhouse] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [OracleDB] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [Mongo] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [SurrealDB] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [KVStore] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [pubsub.Client] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [Solr] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [Dgraph] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [OpenTSDB] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [ScyllaDB] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [ArangoDB] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [Elasticsearch] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [Couchbase] instead.
...
// instrumentation. The Provider shim is retained only for backwards compatibility and
// will be removed in a future release — implement [InfluxDB] instead.
