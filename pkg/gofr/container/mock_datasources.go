...
func (m *MockRedis) Locker() *redislock.Client {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Locker")
	ret0, _ := ret[0].(*redislock.Client)
	return ret0
}

// Locker indicates an expected call of Locker.
func (mr *MockRedisMockRecorder) Locker() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Locker", reflect.TypeOf((*MockRedis)(nil).Locker))
}
