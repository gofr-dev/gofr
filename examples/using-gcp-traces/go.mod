module gofr.dev/examples/using-gcp-traces

go 1.26.0

require (
	gofr.dev v1.60.1
	gofr.dev/pkg/gofr/traces/exporters/gcp v0.0.0-00010101000000-000000000000
)
...
replace gofr.dev/pkg/gofr/traces/exporters/gcp => ../../pkg/gofr/traces/exporters/gcp
