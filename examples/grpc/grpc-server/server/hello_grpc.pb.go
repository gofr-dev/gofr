...
// is compatible with the client package it is being compiled against.
...
// HelloServer is the client API for Hello service.
...
// Hello_ServiceDesc is the client.ServiceDesc for Hello service.
// It's only intended for direct use with client.RegisterService,
