...
func TestEmployee_Get(t *testing.T) {
	...
	tests := []struct {
		...
		{"get success", mock.NewRows([]string{"id", "name", "phone", "email", "city"}).
			AddRow(1, "abc", "2345-678", "abc@gmail.com", "Bangalore").AddRow(2, "cde", "123-331-345", "cde@gofr.dev", "Mysore"), nil, nil,
			[]entity.Employee{{ID: 1, Name: "abc", Phone: "2345-678", Email: "abc@gmail.com", City: "Bangalore"},
				{ID: 2, Name: "cde", Phone: "123-331-345", Email: "cde@gofr.dev", City: "Mysore"}},
		},
...
func TestEmployee_Create(t *testing.T) {
	...
	tests := []struct {
		...
		{"success", entity.Employee{ID: 9, Name: "Sunita", Phone: "01234", Email: "sunita@gofr.dev", City: "Darbhanga"}, nil, nil},
