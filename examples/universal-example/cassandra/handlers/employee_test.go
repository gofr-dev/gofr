...
func TestCassandraEmployee_Get(t *testing.T) {
	tests := []struct {
		...
		{"id=1", []entity.Employee{{ID: 1, Name: "Rohan", Phone: "01222", Email: "rohan@gofr.dev.com", City: "Berlin"}}, nil},
		{"id=1&name=Rohan&phone=01222&email=rohan@gofr.dev.com&city=Berlin",
			[]entity.Employee{{ID: 1, Name: "Rohan", Phone: "01222", Email: "rohan@gofr.dev.com", City: "Berlin"}}, nil},
		{"", []entity.Employee{{ID: 1, Name: "Rohan", Phone: "01222", Email: "rohan@gofr.dev.com", City: "Berlin"},
			{ID: 2, Name: "Aman", Phone: "22234", Email: "aman@gofr.dev.com", City: "florida"}}, nil},
...
func TestCassandraEmployee_Create(t *testing.T) {
	tests := []struct {
		...
		{`{"id": 3, "name":"Shasank", "phone": "01567", "email":"shasank@gofr.dev.com", "city":"Banglore"}`,
			[]entity.Employee{{ID: 3, Name: "Shasank", Phone: "01567", Email: "shasank@gofr.dev.com", City: "Banglore"}}, nil},
...
func TestCassandraEmployee_Create_InvalidInput_JsonError(t *testing.T) {
	tests := []struct {
		...
		// Invalid Input
		{`{"id": 2, "name": "Aman", "phone": "22234", "email": "aman@gofr.dev.com", "city": "Florida"}`,
			nil, []entity.Employee{{ID: 2, Name: "Aman", Phone: "22234", Email: "aman@gofr.dev.com", City: "Florida"}},
			errors.EntityAlreadyExists{}},
		// JSON Error
		{`{"id":    "2", "name":   "Aman", "phone": "22234", "email": "aman@gofr.dev.com", "city": "Florida"}`, nil, nil,
