...
func main() {
	...
	app.GET("/friends/{vertexID}", GetEdgesHandler)
...
func Setup(ctx *gofr.Context) (interface{}, error) {
	...
	if err := createCollection(ctx, "social_network", "persons", false); err != nil {
		return nil, err
	}
	if err := createCollection(ctx, "social_network", "friendships", true); err != nil {
		return nil, err
	}
...
func createCollection(ctx *gofr.Context, dbName, collectionName string, isEdge bool) error {
...
func GetEdgesHandler(ctx *gofr.Context) (interface{}, error) {
	...
	err := ctx.ArangoDB.GetEdges(ctx, "social_network", "social_graph", "friendships", vertexID, &edges)
	if err != nil {
