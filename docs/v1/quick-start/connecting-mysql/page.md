...
Just like any other datastore GoFr also supports connection to MySQL database based on configuration variables. It automatically manages the connection pool, connection retry etc.
...
To switch to a different SQL database, manage connection pool, add SSL. Refer [here](/docs/v1/references/configs#Datastore)
